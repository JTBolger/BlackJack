...
function drawCard(dealingCard) {
    ...
    if (dealingCard == 1) {
        ...
        tempValue = Value(pCard1)
        playerValue = tempValue
        ...
        tempValue = Value(pCard3)
        player = player + tempValue
